...
})(
    {
        ...
        PXKF: [
            function (require, module, exports) {
                ...
                r(
                    r.P + r.F * !require('./_strict-method')([].filter, !0),
                    'Array',
                    {
                        filter: function (r) {
        ...
        O0lf: [
            function (require, module, exports) {
                ...
                r(
                    r.P + r.F * !require('./_strict-method')([].map, !0),
                    'Array',
                    {
                        map: function (r) {
                            return e(this, r, arguments[1]);
            ...
            function (require, module, exports) {
                ...
                var e = require('./_global'),
                    ...
                    R = function (e, r) {
                        h(e);
                        for (
                            var t, i = b((r = g(r))), n = 0, o = i.length;
                            o > n;
                ...
                W ||
                    (n(
                        (N = function () {
                            ...
                            return (
                                t && z && A(Q, e, { configurable: !0, set: i }),
                                B(e)
                            );
                        })[I],
                        'toString',
                    ...
                    return new Promise(function (c, p) {
                        ...
                        function T() {
                            d.cancelToken && d.cancelToken.unsubscribe(f),
                                d.signal &&
                                    d.signal.removeEventListener('abort', f);
                        }
                        ...
                        if (d.auth) {
                            var v = d.auth.username || '',
                                q = d.auth.password
                                    ? unescape(
                                          encodeURIComponent(d.auth.password)
                                      )
                                    : '';
                        ...
                        if (
                            ...
                            (E.ontimeout = function () {
                                ...
                                d.timeoutErrorMessage &&
                                    (e = d.timeoutErrorMessage),
                                    p(
                                        i(
                                            e,
                                            d,
        ...
        Qj6T: [
            function (require, module, exports) {
                ...
                module.exports = function (n, t) {
                    ...
                    return (
                        e.forEach(
                            Object.keys(n).concat(Object.keys(t)),
                            function (n) {
                                var t = c[n] || o,
                                    r = t(n);
                    ...
                    d &&
                        d.addEventListener('submit', function (e) {
                            ...
                            var s = document.getElementById('name').value,
                                ...
                                u = document.getElementById('photo').files[0],
                                t = new FormData();
                            t.append('name', s),
                                t.append('email', o),
                                t.append('photo', u),
