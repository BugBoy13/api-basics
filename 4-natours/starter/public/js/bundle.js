...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidmFyZGFhbi0yMjEiLCJhIjoiY2t2anlsdjdxMzB1NjJwcGdiNHFhNXF3cCJ9.8WKbIoWth4WEqBig0CJWnA';
...
var stripe = Stripe('pk_test_51JspTqSENP6ehdlzy1Vx7iYR3POsG159T1jLDr2KtikchfBHaOHwquWVxGU2peh1yOqPOOqGnRiM1Wl3Orn4bpjq00uwrqrY03');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            console.log(tourId); // 1. Get the checkout session from server
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Processing...'; // data defined on button as data-tour-id, automatically converts in camel case, and data comes in dataset object
